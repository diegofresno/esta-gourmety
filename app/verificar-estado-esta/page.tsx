...
export default function VerificarEstadoEstaPage() {
  return (
    <>
      ...
      <PageHero
        breadcrumb={[{ label:'Inicio', href:'/' }, { label:'Verificar estado ESTA' }]}
        title="Verificar el estado de tu ESTA"
        subtitle="Comprueba si tu ESTA está aprobado, pendiente o denegado antes de volar"
        pills={['Verificación inmediata', 'Estado oficial CBP']}
      />
